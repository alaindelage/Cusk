...
\begin{quote}
	So he had come upon \textbf{this marginal perspective sidlingly, as it were, from a sideways direction, participating in its disenfranchisements, in its mute and broken identity, with the difference} that he had succeeded in giving it a voice. 3
\end{quote}
\vskip 2ex
...
\begin{quote}
	she noticed that he began to speak openly about his technique, explaining the diﬃculties of inverted painting that \textbf{could be resolved only through the use of photographs}. \textbf{Later, he rejected the photographic medium} and the paintings became even larger and more dreamlike and abstract.\\[1ex] 
